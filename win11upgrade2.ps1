    ...
    try {
        ...
        if ($tpm) {
            ...
            if ($tpmVersion -notlike "*2.0*") {
                ...
                Set-CustomRegistryValue "AllowUpgradesWithUnsupportedTPM" # Added TPM bypass logic
                return $false
            }
            return $true
        } else {
...
# Removed Check-SecureBoot function
# Removed Check-UEFI function
...
function checkCompatibility {
    ...
    # Secure Boot and UEFI checks removed
...
function main {
    ...
    # Explicitly set bypass registry keys for Secure Boot and UEFI, as the checks are removed.
    # The keys needed are AllowUpgradesWithUnsupportedSecureBoot and AllowUpgradesWithUnsupportedOS
    Write-Log "Setting registry bypass for UEFI/Secure Boot standards."
    Set-CustomRegistryValue "AllowUpgradesWithUnsupportedSecureBoot"
    # Setting the generic 'AllowUpgradesWithUnsupportedOS' is the most common bypass for both UEFI/Secure Boot.
